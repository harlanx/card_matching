...
class _FlipCardGameState extends State<FlipCardGame> {
                          ...
                          if (_previousIndex != index) {
                            if (_data[_previousIndex] != _data[index]) {
                              ...
                              Future.delayed(Duration(milliseconds: 800), () {
                                ...
                                _gameAudioManager.eventPlay('Wrong', volume: 1.0);
                                _previousIndex = index;
                                _cardStateKeys[_previousIndex].currentState!.toggleCard();
                              ...
                              if (_cardFlips.every((result) => result == false)) {
                                Future.delayed(const Duration(milliseconds: 1), () {
                                  setState(() {
                                    ...
                                    _gameAudioManager.eventPlay('Win', volume: 0.7);
                                ...
                                _gameAudioManager.eventPlay('Correct', volume: 0.7);
                              }
                            }
                          }
                        }
  ...
  void restart() {
    _gameAudioManager.musicPlay('Start', loop: true, volume: 0.3);
